#!/bin/bash 
declare -a STORY_ELEMS=("OnceUponATime720x1280" "AndEveryDay720x1280" "ThenOneDay720x1280" "BecauseOfThat720x1280" "UntilFinally720x1280" "AndEverSinceThen720x1280")
#1280x720
IPHONE_WIDTH=720
IPHONE_HEIGHT=1280
IPHONE_EXT=".mov"
...
do
   ...
   iphone_int_cmd="ffmpeg -pattern_type glob -loop 1 -t 1 -framerate $FRAMERATE -y -i ./$jpg -pix_fmt $IPHONE_PIXEL_FORMAT $iphone_int_mov" 
